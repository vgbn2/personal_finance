...
class PersistenceBridge {
  constructor() {
    ...
    if (this.client) console.log('[PERSISTENCE] Supabase bridge initialized');
    else console.warn('[PERSISTENCE] Supabase credentials missing, falling back to console only');
  }
