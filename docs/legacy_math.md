...
## Phase 1 Math Already Ported Or Being Ported

Phase 1 covers the smallest useful subset of `simForecast`.
...
Phase 1 C++ uses deterministic return only, without contributions, taxes, housing, leverage, inflation, kids, or events.
...
- wage growth does not affect Phase 1 deterministic compounding unless contributions are enabled
