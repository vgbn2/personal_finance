...
The platform needs one coherent stream for assets before contributors add strategies, CNN models, or execution. This document defines the planned data shape. It is a scaffold contract, not a live ingestion implementation.
