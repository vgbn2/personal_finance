...
This repository is a trading-platform scaffold. Many files are intentionally empty or placeholder-only so contributors can claim clear modules without guessing names or ownership.
